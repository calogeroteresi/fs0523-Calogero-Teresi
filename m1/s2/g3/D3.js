...
for (let x = 0; x < starWarsCharacters.length; x++){
  let nome = starWarsCharacters[x].name;
...
for (let x = 0; x < starWarsCharacters.length; x++){
  let y = starWarsCharacters[x];
  coloreOcchi = y.eye_color;

  switch (coloreOcchi){
    case "blue":
      eyeColor.blue.push(y);
      break;
    case "yellow":
      eyeColor.yellow.push(y);
      break;
    case "brown":
      eyeColor.brown.push(y);
      break;
    case "red":
      eyeColor.red.push(y);
      break;
    case "blue-gray":
      eyeColor.blueGray.push(y);
      break;
...
for (let x = 0; x < characters.length; x++){
  let seleziona = characters[];
  if (characters[x] === femaleCharacters.name){
    characters.splice(x,2);
